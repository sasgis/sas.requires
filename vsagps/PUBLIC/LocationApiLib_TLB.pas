...
// *********************************************************************//
  ILocationReport = interface(IUnknown)
    ...
    function GetSensorID(out pSensorID: TGUID): HResult; stdcall;
    function GetTimestamp(out pCreationTime: _SYSTEMTIME): HResult; stdcall;
    function GetValue(var pKey: _tagpropertykey; out pValue: tag_inner_PROPVARIANT): HResult; stdcall;
  end;
