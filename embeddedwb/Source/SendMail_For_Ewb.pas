...
{$IFDEF UNICODE}
      lpAttachArray := TlpAttachArray({$ifdef DELPHIXE4_UP}AnsiStrings.{$endif}AnsiStrAlloc(nFileCount *
...
{$ENDIF UNICODE}
  ...
  begin
{$IFDEF UNICODE}
    lpRecipArray := TlpRecipArray({$ifdef DELPHIXE4_UP}AnsiStrings.{$endif}AnsiStrAlloc(Recipients.Count *
